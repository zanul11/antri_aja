        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 user-profile layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6 ">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{url('artikel/create')}}" class="mt-2 edit-profile"> <i data-feather="plus" class="text-default"> </i></a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" onclick="deleteData('/artikel','{{$dt->id}}')"><i data-feather="trash" class="text-danger"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
