        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 user-profile layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6 ">
                <div class="d-flex justify-content-between">
                    <h3 class=""> {{$page_name}} / {{$category_name}} - {{$faskes->nama_faskes}}</h3>
                    <a href="{{url('/data-faskes/'.$faskes->id)}}" class="mt-2  text-danger layout-spacing"><i data-feather="x"></i></a>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                    <form id="contact" class="section contact layout-spacing" method="POST" action="{{($action==='Tambah')?'/data-akun':'/data-akun/'.$akun->id}}">
                        @if($action=='Edit')
                        @method('PUT')
                        @endif
                        @csrf
                        <div class=" info">
                            ...
                            <div class="row">
                                <div class="col-md-11 mx-auto">
                                    <div class="row">
                                        <input type="hidden" name="email_faskes" value="{{$faskes->email}}">
                                        <input type="hidden" name="id_faskes" value="{{$faskes->id}}">
                                        <input type="hidden" name="parent_faskes" value="{{$faskes->parent}}">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control mb-4" name="password" id="password" value="{{(isset($akun))?$akun->password_show:(old('password')??'')}}" placeholder="{{($action=='Edit')?'Cant show':'Write your password'}}" {{($action=='Tambah')?'required':''}}>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" placeholder="Alamat" name="alamat" rows="5" required>{{(isset($akun))?$akun->alamat:(old('alamat')??'')}}</textarea>
                                            </div>
