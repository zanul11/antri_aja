                            ...
                            <center>
                                <div class=" col-lg-6 inv--product-table-section">
                                    ...
                                    <div class="pcmall-paymentfe_3ro10m">
                                        ...
                                        <!-- <div class="pcmall-paymentfe_3_QFHr">
                                            <div class="pcmall-paymentfe_3J1-Gy">Dicek dalam 10 menit setelah pembayaran berhasil</div>
                                            <div class="pcmall-paymentfe_xVd6cx">Bayar pesanan ke Virtual Account di atas sebelum membuat pesanan kembali dengan Virtual Account agar nomor tetap sama.</div>
                                            <div class="pcmall-paymentfe_xVd6cx">Menerima transfer dari semua Bank berlogo ATM Bersama, PRIMA, dan Link</div>
                                        </div> -->
                                    </div>
