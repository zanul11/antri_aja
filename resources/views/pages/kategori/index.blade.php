                    ...
                    <table id="zero-config" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$dt->kategori}}</td>
                                <td>
                                    <a href="#" onclick="showModalsEdit('{{$dt->id}}', '{{$dt->kategori}}')"><i data-feather="edit-2" class="text-warning"></i></a>
                                    <a href="#" onclick="deleteData('/kategori','{{$dt->id}}')"><i data-feather="trash" class="text-danger"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="modal fade" id="addSepesialis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-info" id="myForm" novalidate enctype="multipart/form-data" method="post" action="/kategori" autocomplete="off">
                    @csrf
                        ...
                        <div class="row">
                            <div class="modal-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="kategori" id="kategori" class="form-control" required></input>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="editSpesialis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-info" id="editForm" novalidate enctype="multipart/form-data" method="post" action="/kategori" autocomplete="off">
                    @method('PUT')
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="modal-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="kategori_edit" id="kategori_edit" class="form-control" required></input>
                                </div>
                            </div>
                            <input type="hidden" name="id_kategori" id="id_kategori"></input>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <a href="javascript:;" class="btn btn-white" data-dismiss="modal">Close</a>
...
<script>
    ...
    function showModalsEdit(id, kategori) {
