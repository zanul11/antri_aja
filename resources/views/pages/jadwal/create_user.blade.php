...
@section('content')
<div class="layout-px-spacing" ng-app="app" ng-controller="JadwalController" ng-init="init({{$user->id}})">
                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Input Jadwal Pelayanan {{$user->name}}</h4>
                        </div>
                    </div>
                </div>
...
<script src="{{asset('angular/jadwal_user.js')}}"></script>