                        ...
                        <form method="POST" action="{{ route('login') }}" class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" type="text" placeholder="Email?username" class="form-control @error('username') is-invalid @enderror" name="username" value="admin@cork.com" required autocomplete="username" autofocus>
