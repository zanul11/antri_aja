    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu {{$hasActive}}">
                <a href="{{$menu['url']}}" data-active="{{ ($category_name === $menu['title']) ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === $menu['title']) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
                        @php
                        echo $menu['icon'];
                        @endphp
