            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                        <h1> <strong>AntriAja</strong></h1>
                        <p>Solusi Antrian Anda di Masa Pandemi Covid-19</p>
                        <a href="#about" class="main-button-slider">Pelajari Lebih Lanjut</a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                        <img src="{{asset('assets/img/logo.png')}}" class="rounded img-fluid d-block mx-auto" alt="First Vector Graphic">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="{{asset('assets/img/logo2.png')}}" class="rounded img-fluid d-block mx-auto" alt="App">
                    <br>
                    <img src="{{asset('assets/img/logo2.png')}}" class="rounded img-fluid d-block mx-auto" alt="App">
        ...
        <div class="container">
            <div class="row">
                <div class="left-text col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix">
                    ...
                    <ul>
                        <li>
                            <img src="{{asset('landing_page/images/about-icon-01.png')}}" alt="">
                            <div class="text">
                ...
                <div class="right-image col-lg-7 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="{{asset('landing_page/images/right-image.png')}}" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="owl-carousel owl-theme">
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="{{asset('landing_page/images/service-icon-01.png')}}" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="{{asset('landing_page/images/service-icon-02.png')}}" alt=""></i>
                        </div>
                    ...
                    <div class="item service-item">
                        <div class="icon">
                            <i><img src="{{asset('landing_page/images/service-icon-03.png')}}" alt=""></i>
                        </div>
